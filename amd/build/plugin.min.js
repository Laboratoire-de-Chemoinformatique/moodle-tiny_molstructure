...
/**
   ...
   */(Configuration);var _default=(async()=>{const[tinyMCE,setupCommands,pluginMetadata]=await Promise.all([(0,_loader.getTinyMCE)(),(0,_commands.getSetup)(),(0,_utils.getPluginMetadata)(_common.component,_common.pluginName)]);return tinyMCE.PluginManager.add(_common.pluginName,(editor=>((0,_options.register)(editor),setupCommands(editor),pluginMetadata))),["".concat(_common.component,"/plugin"),Configuration]})();return _exports.default=_default,_exports.default}));
